...
import {ERC20ExtendedUpgradeable} from "./ERC20ExtendedUpgradeable.sol";
import {IERC20} from "./IERC20.sol";
import {IMTokenLike} from "./IMTokenLike.sol";
import {IMExtension} from "./IMExtension.sol";
import {ISwapFacility} from "./ISwapFacility.sol";
...
abstract contract MExtension is IMExtension, ERC20ExtendedUpgradeable {
    ...
    constructor(address mToken_, address swapFacility_) {
        ...
        if ((swapFacility = swapFacility_) == address(0))
            revert ZeroSwapFacility();
    }
     ...
     */
    function _revertIfInsufficientBalance(
        address account,
        uint256 amount
    ) internal view {
