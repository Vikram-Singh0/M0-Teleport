...
abstract contract ERC20ExtendedUpgradeableStorageLayout {
    ...
    function _getERC20ExtendedStorageLocation()
        internal
        pure
        returns (ERC20ExtendedStorageStruct storage $)
    {
        assembly {
    ...
    IERC20Extended
{
    ...
    function __ERC20ExtendedUpgradeable_init(
        ...
        ERC20ExtendedStorageStruct
            storage $ = _getERC20ExtendedStorageLocation();
    ...
    function permit(
        ...
        _revertIfInvalidSignature(
            owner_,
            _permitAndGetDigest(owner_, spender_, value_, deadline_),
            v_,
            r_,
            s_
        );
    ...
    function _approve(
        ...
        _setAllowance(
            _getERC20ExtendedStorageLocation(),
            account_,
            spender_,
            amount_
        );
                ...
                _getDigest(
                    keccak256(
                        abi.encode(
                            ...
                            spender_,
                            amount_,
                            _getStatefulERC712ExtendedStorageLocation().nonces[
                                owner_
                            ]++,
                            deadline_
                        )
